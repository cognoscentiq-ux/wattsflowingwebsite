 ...
 * VITE_WHATSAPP_NUMBER=441234567890
 * VITE_WHATSAPP_MESSAGE=Hi, I found your site and would like to enquire about your services.
 */
...
const WhatsAppChat: React.FC = () => {
  ...
  if (!rawNumber) {
    // If no number is provided, don't render anything
    return null;
  }

  // Normalize number: remove spaces, parentheses, dashes
